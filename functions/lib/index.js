...
exports.updateOrganizationDetails = exports.onOrganizationCreate = exports.onUserCreate = exports.sendOrganizationInvite = void 0;
...
exports.sendOrganizationInvite = functions
    .region("us-central1")
    ...
    if (orgData === null || orgData === void 0 ? void 0 : orgData.domain) {
    ...
    if (orgData === null || orgData === void 0 ? void 0 : orgData.expiryDate) {
        const now = new Date();
    ...
    console.log(`[INVITE] Initiating invite for ${email} by ${(_a = context.auth) === null || _a === void 0 ? void 0 : _a.uid}`);
    try {
        ...
        try {
            ...
            await logRef.set({
                ...
                organizationId,
                role,
                invitedBy: (_b = context.auth) === null || _b === void 0 ? void 0 : _b.uid,
                timestamp: admin.firestore.FieldValue.serverTimestamp(),
                status: 'error',
                message: (error === null || error === void 0 ? void 0 : error.message) || "Unknown error while sending invite",
        ...
        throw new functions.https.HttpsError("internal", (error === null || error === void 0 ? void 0 : error.message) || "Unknown error while sending invite.");
    }
});
/**
 ...
 */
exports.onOrganizationCreate = functions.firestore
...
exports.updateOrganizationDetails = functions
    .region("us-central1")
    .https.onCall(async (data, context) => {
